...
@section('content')
    <div class="max-w-4xl mx-auto p-6 bg-white rounded-xl shadow">
        ...
        <p class="text-lg text-gray-700 mb-2"> Your Score: <span class="font-semibold">{{ $attempt->score }}</span></p>
        ...
        <a href="{{ route('exam', $exam->id) }}" class="mt-6 inline-block px-4 py-2 bg-blue-600 text-white rounded-lg"> Retake Exam</a>
    </div>
@endsection
